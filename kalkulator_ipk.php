...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* --- [PERBAIKAN CSS] Styling untuk grup input matkul & tombol hapus --- */
        .matkul-input-group {
        ...
        .matkul-input-group > div:first-child {
            flex-grow: 1; /* Membuat area input mengisi ruang yang tersedia */
        }
...
<body>
    ...
    <div class="container">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:15px;">
            <a href="index.php" class="back-link" style="margin:0;">&larr; Halaman Utama</a>
                ...
                <div class="calculator-card">
                    ...
                    <form id="form-ipk">
                        ...
                        <div id="matkul-container">
                            <div class="matkul-input-group" id="matkul-template">
                                <div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // const matkulTemplate = document.getElementById('matkul-template'); // Dihapus dari sini
        ...
        let riwayatData = [];
        let settings = {};
        let matkulTemplateHTML = ''; // Variabel baru untuk menyimpan HTML template
        ...
        const init = () => {
            ...
            // --- [PERBAIKAN UTAMA] ---
            // 1. Ambil elemen template
            const matkulTemplateElement = document.getElementById('matkul-template');
            if (matkulTemplateElement) {
                // 2. Simpan HTML-nya ke dalam variabel
                matkulTemplateHTML = matkulTemplateElement.outerHTML;
                // 3. Hapus elemen template dari dokumen
                matkulTemplateElement.remove();
            }
        ...
        const setupEventListeners = () => {
            ...
            addMatkulBtn.addEventListener('click', () => addMatkulField()); // Memanggil fungsi tanpa argumen
        ...
        const addMatkulField = (matkulData = null) => {
            // --- [PERBAIKAN UTAMA] ---
            // Buat elemen baru dari string HTML yang sudah disimpan
            if (!matkulTemplateHTML) return; // Jangan lakukan apa-apa jika template tidak ada
            ...
            // Logika ini menambahkan tombol hapus ke setiap field KECUALI yang pertama
            if (matkulContainer.children.length > 0) {
        ...
        const handleFormSubmit = (e) => {
            ...
            if (!semesterNama) { alert('Nama semester tidak boleh kosong.'); return; }
            ...
            matkulElements.forEach(el => {
                ...
                if (!nama || isNaN(sks) || isNaN(tugas) || isNaN(uts) || isNaN(uas) || isNaN(hadir)) { return; }
                ...
                totalSks += sks; totalBobotNilai += sks * bobot;
            });
            if (semesterMatkul.length === 0) { alert('Silakan isi data mata kuliah terlebih dahulu.'); return; }
            ...
            if (editingIndex > -1) { riwayatData[editingIndex] = semesterObj; } else { riwayatData.push(semesterObj); }
